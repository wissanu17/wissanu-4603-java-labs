...
public class AthleteFormV9 extends AthleteFormV8 {
    ...
    // public void addListenersToTxtField() {        
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (actionObject == nameField) {
            JOptionPane.showMessageDialog(null, "Name is changed to " + nameField.getText());
        } else if (actionObject == weightField) {
            JOptionPane.showMessageDialog(null, "Weight is changed to " + weightField.getText());
        } else if (actionObject == heightField) {
            JOptionPane.showMessageDialog(null, "Height is changed to " + heightField.getText());
        } else if (actionObject == dateField) {
            JOptionPane.showMessageDialog(null, "Date of birth is changed to " + dateField.getText());
        }

        //Action to nationality combo box
        else if (actionObject == nationComboBox) {
