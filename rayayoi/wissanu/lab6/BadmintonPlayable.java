 /**
 * This interface is called BadmintonPlayable that have two attributes are
 * racketLength and worldRanking and has 4 public methods are
 * getRacketLength(), setRacketLength(double), getWorldRanking(), setWorldRanking(int).
 * 
