...
public class BadmintonPlayerV3 extends BadmintonPlayerV2 implements Sprinter, BadmintonPlayable {
    ...
    @Override
    public void setRacketLength(double racketLength) { this.racketLength = racketLength; }

    // getter method to get racketLength value.
    @Override
    public double getRacketLength() { return racketLength; }

    // setter method to set worldRanking value.
    @Override
    public void setWorldRanking(int worldRanking) { this.worldRanking = worldRanking; }
